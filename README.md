...
![Arquitetura do Sistema PokeAPI](docs/arquitetura-sistema-atualizada.drawio)

**📁 Como visualizar o diagrama:**
- 🔗 **GitHub**: Visualize diretamente aqui no repositório (suporte nativo para .drawio)
- 🎨 **Draw.io**: Abra o arquivo `docs/arquitetura-sistema-atualizada.drawio` em [app.diagrams.net](https://app.diagrams.net)
- 📱 **VS Code**: Use a extensão "Draw.io Integration" para editar
